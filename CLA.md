...
grants the licenses described below; it is **not** a copyright assignment.
...
- "Contribution" means any original work of authorship — including code,
  documentation, or other materials — that You intentionally submit to the
...
and such derivative works. **This license expressly includes the right to
sublicense and to relicense Your Contribution under different license terms**,
including future versions of the project's license, so that the maintainers may
change the project's license without seeking further permission from You.

## 3. Grant of Patent License
You grant to the project maintainers and to recipients of the software a
...
constitutes patent infringement, the patent licenses granted to that entity
...
You are not expected to provide support for Your Contribution. Your Contribution
is provided "AS IS", without warranties or conditions of any kind, except as
required by applicable law.

## How to sign
Contributions are gated by the CLA Assistant bot. When you open your first pull
request, the bot will ask you to confirm agreement by posting a comment. Signing
is a one-time action recorded for future contributions.
