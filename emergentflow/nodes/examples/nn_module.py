"""
emergentflow.nodes.examples.nn_module
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
declarative paths (``emergentflow.codegen.declarative.compile_declarative`` and
...
from emergentflow.ir.common import Paradigm
...
class NnModule(NodeDefinition):
    ...
    def codegen(self, node: Node, ctx: CodegenContext) -> CodeFragment:
        raise NotImplementedError(
            ...
            "emergentflow.codegen.declarative.compile_declarative, not via per-node "
            "codegen."
        )
