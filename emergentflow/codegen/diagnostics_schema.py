...
Pydantic model :class:`~emergentflow.codegen.validation.Diagnostics`; this mirrors
:mod:`emergentflow.ir.schema` for the IR.
"""
...
@public_op(name="ef.diagnostics_json_schema")
