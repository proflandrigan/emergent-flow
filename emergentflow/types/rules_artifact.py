"""
emergentflow.types.rules_artifact
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
version (:data:`~emergentflow.ir.graph.CURRENT_SCHEMA_VERSION`) so the canvas can
...
@public_op(name="ef.build_rules_artifact")
