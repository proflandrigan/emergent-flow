"""
colonymind.nodes.examples.load_sample
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``colonymind.data.load_sample`` directly and the code emitted by ``codegen`` calls the
...
from colonymind.data import SAMPLE_DATASETS, load_sample
...
class LoadSample(NodeDefinition):
    ...
    def codegen(self, node: Node, ctx: CodegenContext) -> CodeFragment:
        ...
        return CodeFragment(
            ...
            body=f"{ctx.out_var('frame')} = cm.data.load_sample(name={name!r})",
        )
