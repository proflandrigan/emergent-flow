"""
colonymind.types.compatibility
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
- :func:`check_cardinality` — whether an IN port's
  :class:`~colonymind.ir.common.Cardinality` permits the number of inbound edges
...
from colonymind.types.registry import TOP_TYPE, TypeRegistry
