...
from colonymind.codegen.naming import NameMap
from colonymind.codegen.wiring import WiringMap
...
class CodegenContext:
    ...
    def preview(cls, node: Node) -> CodegenContext:
        ...
        (e.g. data.load_csv -> ``frame = cm.data.load_csv(...)``). IN and OUT names
