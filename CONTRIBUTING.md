# Contributing to Colony Mind

Welcome! We are excited that you want to contribute to the Colony Mind open-source SDK.
...
Colony Mind uses a license-grant CLA. This means you retain your copyright, but you grant the project maintainers a broad, relicensable license to your contribution. This allows the project to evolve its licensing in the future if necessary. For more details, see [CLA.md](./CLA.md).
...
Contributions made to this repository are for the open-source SDK. The Colony Mind platform itself is managed in a separate proprietary repository. Please read the [Open-Core Boundary](./docs/open-core-boundary.md) documentation for more details. 
