...
// the session id, the optimistic-concurrency "rebase" banner (surfaced by sessionStore's
// pushLocalGraph on a stale_version conflict -- never a silent overwrite), a Leave action, and
// the ProposalPanel. Rendered lazily by App.tsx behind the "Share session" overflow-menu item --
// nothing in this module runs unless the user opens it.
  ...
  return (
    <div data-testid="session-panel">
      ...
      <p style={{ fontSize: "var(--text-sm)", color: "var(--text-secondary)" }}>
        Start a session to let an agent propose changes to this graph, or join
