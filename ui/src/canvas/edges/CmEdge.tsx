// Custom React Flow edge renderer for Colony Mind canvas edges. Purely presentational: it draws
...
export interface CmEdgeData extends Record<string, unknown> {
  incompatible?: boolean;
  reason?: string | null;
}

type CmEdgeType = Edge<CmEdgeData, "cmEdge">;

export function CmEdge(props: EdgeProps<CmEdgeType>): JSX.Element {
  const {
    sourceX,
    sourceY,
    sourcePosition,
